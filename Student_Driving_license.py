...
def DrivingLicense():
    label_id["ID :19827198349"]
    label_name["Name :Wnnie the pooh"]
    label_dob["Date of birth :21 August 1921"]
    label_pin["Pin no :451478"]
    label_address["Address :Disney land,Hong kong"]
    label_vehicle_type["Authorisation to drive the following vehicles"]
# Create a button
